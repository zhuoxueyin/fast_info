...
async def run_source(source_id: str, limit: int, task_run_id: str, trigger: str) -> dict:
    ...
    system_prompt = (
        ...
        '"category_l1": "一级分类，必须是：科技/AI/体育/娱乐/动漫/游戏/财经/汽车/其他 之一", '
        ...
        "- 娱乐：影视、音乐、明星、综艺、演唱会、选秀、真人秀(娱乐圈新闻)\n"
        "- 动漫：动画、漫画、二次元、ACG、声优/配音、番剧、新番、cosplay\n"
        "- 游戏：所有游戏相关 — PC游戏、主机游戏(PS5/Switch/Xbox/任天堂)、手游(原神/王者荣耀)、独立游戏、电竞(LOL/DOTA/CSGO/王者荣耀)\n"
        ...
        "- 其他：社会、教育、健康、生活等不属于以上 8 类的内容\n\n"
        "规则：category_l1 必须从给定列表中选；若文章是科技/AI 产品或产业新闻，即使提到融资也应优先归为科技/AI；游戏行业新闻归'游戏'，动漫行业新闻归'动漫'，娱乐圈新闻(明星八卦/影视/音乐)归'娱乐'；summary 必须有实质内容；title_zh 必须输出。"
    )
