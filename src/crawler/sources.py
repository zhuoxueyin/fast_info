...
CATEGORY_L1 = ["科技", "AI", "体育", "娱乐", "动漫", "游戏", "财经", "汽车", "其他"]

CATEGORY_L2 = {
    "科技": ["互联网", "硬件", "数码评测", "科技融资", "科技投资", "开源"],
    "AI": ["AI框架", "AI芯片", "大模型", "AI应用", "机器人"],
    "体育": ["足球", "篮球", "电竞", "综合"],
    # 娱乐:聚焦娱乐圈(明星八卦/影视/音乐/综艺/演唱会);动漫与游戏已独立成 L1
    "娱乐": ["明星", "影视", "音乐", "综艺", "演唱会"],
    # 动漫:ACG 文化(动画/漫画/二次元/声优)
    "动漫": ["动画", "漫画", "二次元", "声优"],
    # 游戏:覆盖 PC/主机/手游/电竞/产业
    "游戏": ["PC游戏", "主机游戏", "手游", "电竞", "游戏产业"],
...
CATEGORY_LEGACY_MAP = {
    ...
    # 娱乐(娱乐圈:明星/影视/音乐/综艺/演唱会)
    "娱乐": "娱乐", "影视娱乐": "娱乐",
    "明星": "娱乐", "偶像": "娱乐", "选秀": "娱乐", "八卦": "娱乐", "娱乐圈": "娱乐",
    "影视": "娱乐", "电影": "娱乐", "电视剧": "娱乐", "票房": "娱乐",
    "导演": "娱乐", "演员": "娱乐", "奥斯卡": "娱乐", "金球奖": "娱乐", "金马奖": "娱乐",
    "音乐": "娱乐", "歌手": "娱乐", "专辑": "娱乐", "演唱会": "娱乐", "演唱会门票": "娱乐",
    "综艺": "娱乐", "真人秀": "娱乐", "选秀节目": "娱乐",
    # 动漫(ACG:动画/漫画/二次元/声优)
    "动漫": "动漫", "动画": "动漫", "动画片": "动漫", "动画电影": "动漫",
    "漫画": "动漫", "二次元": "动漫", "ACG": "动漫",
    "cosplay": "动漫", "cos": "动漫", "声优": "动漫", "配音": "动漫",
    "番剧": "动漫", "新番": "动漫",
    # 游戏(所有游戏类型)
    "游戏": "游戏", "电子游戏": "游戏", "游戏产业": "游戏",
    "PC游戏": "游戏", "端游": "游戏", "单机": "游戏", "独立游戏": "游戏",
    "主机游戏": "游戏", "PS5": "游戏", "PS4": "游戏", "Switch": "游戏", "Xbox": "游戏",
    "手游": "游戏", "手机游戏": "游戏", "iOS游戏": "游戏", "Android游戏": "游戏",
    "电竞": "游戏", "电竞赛事": "游戏", "英雄联盟": "游戏", "LOL": "游戏",
    "Dota": "游戏", "DOTA2": "游戏", "王者荣耀": "游戏", "CS:GO": "游戏", "CSGO": "游戏",
    "原神": "游戏", "Steam": "游戏", "任天堂": "游戏", "暴雪": "游戏", "米哈游": "游戏",
    "暴雪娱乐": "游戏", "网易游戏": "游戏", "腾讯游戏": "游戏",
    # 财经
